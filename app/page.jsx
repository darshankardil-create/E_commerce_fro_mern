...
const PAGE = () => {
  ...
  return (
    <div>
      ...
      <div
        className={` grid md:grid-cols-3 lg:grid-cols-4 grid-cols-2 w-full justify-items-center py-24 ${adding ? "pointer-events-none" : ""} min-h-screen ${Signinid && acnotfn ? "" : "filter blur-2xl pointer-events-none"}    ${
          checked
