...
const PAGE = () => {
  ...
  return (
    <div>
      ...
      <div
        className={` grid lg:grid-cols-4 grid-cols-2 lg:max-w-800 max-w-120 justify-items-center py-24 ${adding ? "pointer-events-none" : ""} min-h-screen ${Signinid && acnotfn ? "" : "filter blur-2xl pointer-events-none"}    ${
          checked
